...
from pyShicy import Shicy, CMD_HELP, DEVS
...
GCAST_BLACKLIST = [
    ...
    -1001808819173,  # shicy dongs
    -1001718757023,  # panda bangs
]


@Shicy(["fgcast", "fw_cast"])
async def gcast_cmd(client: Client, message: Message):
    if message.reply_to_message:
        ShicyXD = await message.reply("<code>Started global broadcast...</code>")
    else:
