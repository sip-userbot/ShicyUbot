...
from pyShicy.pyrogram import eod
...
CMD_HELP.update(
    {"button": (
        "button",
        {
            "cbutton" : "Untuk membuat pesan button\n\nNOTE: Bot harus ditambahkan ke group atau channel untuk menggunakan modul ini\n\n**Contoh :** `.cbutton test\n[It's Me]<buttonurl:https://t.me/Carddsamss>\n[Channel]<buttonurl:https://t.me/ShicyxCod>\n[Support]<buttonurl:https://t.me/ShicyyXCode:same>`",
        }
    )
    }
)
